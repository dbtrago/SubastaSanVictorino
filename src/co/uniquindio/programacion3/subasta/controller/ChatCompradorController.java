...
public class ChatCompradorController implements Observer {
	...
	public ChatCompradorController() {
	...
	public void enviarMensaje() {
		...
		String mensaje = "Comprador: " + this.txtMensaje.getText() + "\n";

		this.areaChat.appendText(mensaje);
		this.txtMensaje.setText("");

		ChatComprador c = new ChatComprador (600, mensaje);
